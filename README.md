...
Landmarks are drawn on the hand.
A circle is drawn on the thumb tip.
A circle is drawn on the index fingertip.
A line is drawn between the two fingertips.
The finger distance is converted into a value from 0% to 100%.
A brightness bar is shown on the screen.
Project Structure
